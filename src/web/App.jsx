...
const App = () => {
    ...
    return (
        <div className="max-w-md md:max-w-3xl lg:max-w-5xl mx-auto p-5 min-h-screen flex flex-col gap-6 pb-24 relative overflow-hidden text-slate-100 font-sans">
            {/* Background Glow */}
                    ...
                    >
                        ...
                        >
                            <div className="flex-1 flex flex-col w-full max-w-xl mx-auto">
                                ...
                                <div className="flex-1 overflow-y-auto px-8 pb-12 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
